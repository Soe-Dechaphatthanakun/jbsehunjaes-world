...
var q = V((ze, F) => {
  ...
  function b(e, t) {
    ...
    }), e = e.replace(/\[:([^:]+):\]/g, (i, c) => b.characterClasses[c] || i), new b.PCRE(e, a, r, a, s);
  }
  __name(b, "b");
  function pe(e, t) {
    let r = 0, s = 0, a = false;
...
var Q = V((H) => {
  ...
  function ve(e, t) {
    ...
    for (var r = {}, s = t || {}, a = s.decode || Pe, o = 0; o < e.length; ) {
      var n = e.indexOf("=", o);
      if (n === -1) break;
      var i = e.indexOf(";", o);
      if (i === -1) i = e.length;
      ...
      if (r[c] === void 0) {
        ...
        d.charCodeAt(0) === 34 && (d = d.slice(1, -1)), r[c] = je(d, a);
      }
      o = i + 1;
    }
    return r;
...
__name(O, "O");
async function S(e, { request: t, assetsFetcher: r, ctx: s }, { path: a, searchParams: o }) {
  ...
  try {
    switch (e?.type) {
      ...
      case "override": {
        n = P(await r.fetch(A(c, e.path ?? a))), e.headers && m(n.headers, e.headers);
        break;
      }
      case "static": {
    ...
    switch (e.method) {
      ...
      case "POST": {
        let o = globalThis[xe], n = /* @__PURE__ */ __name(async () => {
          let i = await e.json();
          i.data.tags === void 0 && (i.tags ??= z(e, fe) ?? []), await s.set(a, i);
        }, "n");
...
async function be(e) {
  if (e.url.startsWith("blob:")) try {
    let r = `./__next-on-pages-dist__/assets/${new URL(e.url).pathname}.bin`, s = (await j(r)).default, a = { async arrayBuffer() {
      return s;
    }, get body() {
...
var C = class {
  ...
  applyRouteDest(t, r, s) {
    ...
    return y(this.searchParams, w.searchParams), T(this.path) || (this.path = w.pathname), a;
  }
...
async function ke(e, { path: t = "/404", status: r, headers: s, searchParams: a, body: o }, n) {
  ...
  } else c = await S(n[t], e, { path: t, status: r, headers: s, searchParams: a });
  let d = s.normal;
...
var Ps = { async fetch(e, t, r) {
  ...
  return a.run({ ...t, NODE_ENV: "production", SUSPENSE_CACHE_URL: R }, async () => o.run({ env: t, ctx: r, cf: e.cf }, async () => {
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.9530202521893345.mjs.map
